...
<head>
  ...
  <title>Rent Camera | Camera List</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'backend/paket'?>"><i class="fa fa-gift"></i> Paket Sewa</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Info Fotografi</li>
      </ol>
    </section>
...
<!-- ============ MODAL ADD Info Fotografi =============== -->
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h3 class="modal-title" id="myModalLabel">Tambah Info Fotografi</h3>
    </div>
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/info_fotografi/simpan_info_fotografi'?>" enctype="multipart/form-data">
        <div class="modal-body">

            <div class="form-group">
                <label class="control-label col-xs-2" >Info Fotografi</label>
                <div class="col-xs-8">
                    <input name="nama_if" class="form-control" type="text" placeholder="Info Fotografi..." required>
                </div>
            </div>
...
<?php
    ...
    foreach($data->result_array() as $a):
      ...
      $nama_if=$a['nama_if'];
?>
<!-- ============ MODAL EDIT Info Fotografi =============== -->
<div class="modal fade" id="ModalUpdate<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h3 class="modal-title" id="myModalLabel">Update Info Fotografi</h3>
    </div>
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/info_fotografi/update_info_fotografi'?>" enctype="multipart/form-data">
        <div class="modal-body">

            <div class="form-group">
                <label class="control-label col-xs-2" >Info Fotografi</label>
                <div class="col-xs-8">
                    <input name="nama_if" value="<?php echo $nama_if;?>" class="form-control" type="text" placeholder="Objek Info Fotografi..." required>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Hapus Info Fotografi</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'backend/info_fotografi/hapus_info_fotografi'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                          <p>Apakah Anda yakin mau menghapus Info Fotografi <b><?php echo $nama_if;?></b> ?</p>
  ...
  $(function () {
    ...
    <?php if($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Info Fotografi Berhasil disimpan ke database.",
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Info Fotografi berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Info Fotografi Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
