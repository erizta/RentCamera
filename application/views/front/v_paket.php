                ...
                <div id="content">
                    <div id="blog" class="container section">
                        ...
                        ?>
                            <div class="blog-item">
                                <div class="hover">
                                    <a href="<?php echo base_url().'paket/detail_paket/'.$idberita;?>">
                                    <div class="readmore">
                                        <span class="text"><span class="anchor"></span></span>
                                    </div> <img width="560" height="120" src="<?php echo base_url().'assets/gambars/'.$gbr;?>" alt="" /> </a>
                                </div>
                                <h2 class="blog"><a href="<?php echo base_url().'paket/detail_paket/'.$idberita;?>"><?php echo $judul;?></a></h2>
                                ...
                                <p>
                                    <a href="<?php echo base_url().'paket/detail_paket/'.$idberita;?>" class="small gray button">Read more ...</a>
                                </p>
                            </div>
                            <?php
                            }
                            ...
                            <div class="sidebar-item">
                                ...
                                <ul id="latest-events" class="square">
                                    ...
                                    foreach ($brt->result_array() as $b) {
                                        ...
                                        $hrgbody=$b['hrg_body'];
                                        $hrglensa=$b['hrg_lensa'];
                                        $gbr=$b['gambar'];
                                        $des=$b['deskripsi'];
                                ?>
                                    <li>
                                        <a href="<?php echo base_url().'paket/detail_paket/'.$idpaket;?>">
                                          <img width="50" height="50" src="<?php echo base_url().'assets/gambars/'.$gbr;?>" alt="" />
                                          <span><?php echo $nmpaket;?></span></a>
                                    </li>
                                <?php
                                    }
                                ?>
